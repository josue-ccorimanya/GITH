...
<head>
    ...
    <?php include './inicio/link.php'; ?>
</head>
<body id="container-page-registration">
    <?php include './inicio/navbar.php'; ?>
    <section id="form-registration">
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">Electronica el Chino</small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    ...
                    <br>
                    <img src="assets/img/registrousuarioschino.jpg" alt="electrodomesticos" class="img-responsive">
                </div>
                       ...
                       <form class="form-horizontal FormCatElec" action="process/regclien.php" role="form" method="post" data-form="save">
                           <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="text" placeholder="Ingrese su número de RUC" required name="clien-nit" data-toggle="tooltip" data-placement="top" title="Ingrese su número de RUC. Solamente números y guiones(-)" maxlength="30" pattern="[0-9-]{14,30}">
                              </div>
                            </div>
                            <br>
                            <div class="form-group">
